...
def findListOfMatchingChars(possibleChar, listOfChars):
    ...
    for possibleMatchingChar in listOfChars:                # for each char in big list
        ...
        if (fltDistanceBetweenChars < (possibleChar.fltDiagonalSize * MAX_DIAG_SIZE_MULTIPLE_AWAY) and fltAngleBetweenChars < MAX_ANGLE_BETWEEN_CHARS  and fltChangeInHeight < MAX_CHANGE_IN_HEIGHT and fltChangeInArea < MAX_CHANGE_IN_AREA and  fltChangeInWidth < MAX_CHANGE_IN_WIDTH) :
